...
const App = () => {
  ...
  const content = {
    english: {
      ...
      reception_addr1: "3rd Floor, R.S. Brother's Building, Panama,",
    ...
    telugu: {
      ...
      bride_parents: "(గుడివాడ వాస్తవ్యులు శ్రీ కొడాలి నాగేంద్రరావు - శ్రీమతి కవిత కుమారి దంపతుల పుత్రిక)",
      ...
      reception_addr1: "3వ అంతస్తు, ఆర్.ఎస్. బ్రదర్స్ భవనం, పనామా,",
